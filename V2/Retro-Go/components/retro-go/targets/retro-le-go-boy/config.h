// Target definition
#define RG_TARGET_NAME              "retro-le-go-boy"
...
#define RG_GAMEPAD_GPIO_MAP {\
    ...
    {RG_KEY_OPTION, .num = GPIO_NUM_48, .pullup = 1, .level = 0},\
}
#define RG_RECOVERY_BTN RG_KEY_SELECT


// Battery
#define RG_BATTERY_DRIVER           1
#define RG_BATTERY_ADC_UNIT         ADC_UNIT_1
#define RG_BATTERY_ADC_CHANNEL      ADC_CHANNEL_3 //GPIO_NUM_4
...
#define RG_GPIO_LCD_RST             GPIO_NUM_4 // no use change
...
#define RG_GPIO_SND_AMP_ENABLE      GPIO_NUM_41 // no use change
